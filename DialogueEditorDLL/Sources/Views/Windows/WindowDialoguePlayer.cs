...
{
    public partial class WindowDialoguePlayer : Form
    {
        #region Internal vars
        protected DialogueController currentDialogueController = null;
        ...
        #region Constructor
        public WindowDialoguePlayer(DialogueController dialogueController, bool wholeDialog /* else from current node */)
        {
            InitializeComponent();
        ...
        public void Play(DialogueNode nodeFrom = null)
        {
            ...
            else if (currentDialogueController.Dialogue.RootNode != null)
            {
                PlayNode(currentDialogueController.Dialogue.RootNode.Next);
            }
            else
            {
                Stop();
        ...
        protected void PlayNode(DialogueNode nextNode, bool forward = true)
        {
            ...
            if (currentNode is DialogueNodeSentence)
            {
                ...
                Actor speaker = ProjectController.Project.GetActorFromID(sentence.SpeakerID);
                if (speaker != null)
                {
                ...
                Actor listener = ProjectController.Project.GetActorFromID(sentence.ListenerID);
                if (listener != null)
                {
        ...
        {
            if (currentDialogueController != null && currentNode != null)
            {
                currentDialogueController.EditNode(currentNode);
            }
            Close();
        }
